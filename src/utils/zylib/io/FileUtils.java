...
public class FileUtils {
  ...
  public static String findLocalRootPath(final Class<?> klazz) {
    ...
    if (classUrl==null) {
		System.err.println("Cannot find resource for class " + klazz.getCanonicalName());
	}
  ...
  public static String getPathEllipsis(
    ...
    if (maxlen>=(4*ellLen)) {
		System.err.println("Maximum length too short");
		return filename;
	}
   ...
   */
	public static void writeTextFile(final File file, final String text) throws IOException {
		if (file == null) {
			System.err.println("Error: file argument can not be null");
		}
		if (text == null) {
			System.err.println("Error: text argument can not be null");
		}
