...
public class Dijkstra {  
    ...
    public Map<Integer, List<Integer>> pathListMap;  
    /** 
     * 构造函数，必须初始化路径矩阵和起始点 
     * @param graph 
     * @param start 
    ...
    public Dijkstra(int[][] graph, int start) {
        ...
        this.pathListMap = new HashMap<Integer, List<Integer>>();
    ...
    public static void main(String[] args) {  
        ...
        System.out.println(INF+" "+Integer.MAX_VALUE);
        
        int start = 0;  
        int end = 0;  
        int length = matrix2.length;
        Dijkstra dijkstra = new Dijkstra(matrix2, start);  
